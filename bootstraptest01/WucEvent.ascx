            ...
            <div class="panel-heading">
              ...
              <div class="row">
                <div class="hidden-xs col-xs-8 col-md-8 col-lg-8">
                  <img class="media-object pull-left visible-md img-rounded" src="https://lorempixel.com/650/350">
                  <div class="media">
                    <a class="pull-left" href="#">    <img class="media-object visible-sm" src="https://lorempixel.com/700/400">  </a>
                    <div class="media-body"></div>
                  </div>
                </div>
                <div class="pull-left col-md-4 col-lg-8">
                  <img src="https://lorempixel.com/780/400" class="visible-lg img-rounded">
                </div>
                <div class="col-sm-4 col-md-4">
                  ...
                  <ul class="list-group">
                    <li class="list-group-item">kl 18:00</li>
